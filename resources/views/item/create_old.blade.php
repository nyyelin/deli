              ...
              <div class="col-md-8">
                <div class="form-group row">
                  ...
                  <div class="col">
                    ...
                    <input class="form-control" id="txtDate" type="date" name="assign_date"  value="{{old('assign_date')}}">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $(".mytownship").change(function(){
      ...
      $.post("/getdeliveryman",{id:id},function (res) {
        // alert('hello')
        var html="";
        // html+=`<optgroup label="Choose Deliveryman">`
        html+=`<option>Choose Deliveryman</option>`
        $.each(res,function(i,v){
          html+=`<option value="${v.id}">${v.user.name}</option>`
        })
        // html +=`</optgroup>`
        $("#InputReceiverDeliveryman").html(html);
      })
    })
